      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-16 lg:px-14 xl:px-20">
        ...
        >
          ...
          <motion.button
            ...
            className="w-full flex items-center justify-center gap-3 py-4 bg-white text-[#050505] font-['DM_Sans'] font-semibold text-sm hover:bg-white/90 transition-all disabled:opacity-60 mb-5"
